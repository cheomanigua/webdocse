...
Changes here will affect the home page (`content/_index.md`) 
...
List of terms. Changes here will affect the autogenerated taxonomy index page (e.g. the page listing all tags).

<br>

##### `term.html`

List of pages for one term. Changes here will affect pages listing content under a specific taxonomy term (e.g. all pages under a single tag).
